...
against a runtime. The [runtime documentation](../runtime.md) covers
what the runtime functions do, in detail, but you may need to read the
[JPL runtime source code](../rt/) to answer some questions you have.
